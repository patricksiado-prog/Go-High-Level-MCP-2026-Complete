...
- 2026-06-14: Built SETUP_NEW_PC.bat (one-click full toolkit install + creds download) and uploaded to Drive Optimus Installer folder. Live: 77571 (La Porte) is a green-rich target. --net stay-on-map loop fix shipped. Next: capture 77571 -> enrich -> load.
